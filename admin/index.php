...
<head>
	...
	<link href="<?=$func->lay_favicon('favicon','admin')?>" rel="shortcut icon" type="image/x-icon" />
...
<body data-title="<?= $template ?>" class="sidebar-mini hold-transition text-sm <?=(!isset($_SESSION[$login_admin]['active']) || $_SESSION[$login_admin]['active']==false)?'login-page':''?>">

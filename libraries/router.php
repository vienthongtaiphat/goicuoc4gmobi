<?php
    ...
    $requick = array(
        ...
        // array("tbl"=>"product_brand","field"=>"idb","source"=>"product","com"=>"thuong-hieu","type"=>"menu"),
        array("tbl"=>"product","field"=>"id","source"=>"product","com"=>"san-pham","type"=>"san-pham",'menu'=>true),
        /* Tags */
        // array("tbl"=>"tags","tbltag"=>"product","field"=>"id","source"=>"tags","com"=>"tags-san-pham",
        //  "type"=>"san-pham",'menu'=>false),
        ...
        // array("tbl"=>"product","field"=>"id","source"=>"product","com"=>"khuyen-mai","type"=>"san-pham",'menu'=>true),
        /* Video */
        ...
        array("tbl"=>"static","field"=>"id","source"=>"static","com"=>"chuong-trinh-khuyen-mai","type"=>"chuong-trinh-khuyen-mai",'menu'=>true),
        /* Liên hệ */
	...
	if($com != 'tim-kiem' && $com != 'account' && $com != 'sitemap')
	{
		foreach($requick as $k => $v)
		{
			...
			{
				$row = $d->rawQueryOne("select id from #_$url_tbl where $sluglang = ? and type = ? and 
					hienthi > 0 limit 0,1",array($com,$url_type));
	...
	switch($com)
	{
		...
		case 'chuong-trinh-khuyen-mai':
			...
			$title_crumb = "Chương trình khuyến mãi";
			break;
		case 'tuyen-dung':
			$source = "static";
			$template = "static/static";
